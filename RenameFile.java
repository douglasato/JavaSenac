    ...
    public static void main(String[] args) {
        try {
            ...
            if(returnVal1 == JFileChooser.APPROVE_OPTION) {
                System.out.println("You chose to rename this file: " + chooser.getSelectedFile().getName());
            ...
            if(returnVal2 == JFileChooser.APPROVE_OPTION) {
                ...
                System.out.println("You chose to rename this folder: " + chooser.getSelectedFile().getName());
